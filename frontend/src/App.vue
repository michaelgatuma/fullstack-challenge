...
const navigation = [
  { name: "Open Weather Map API", href: "#", current: true },
  { name: "Weather.GOV API", href: "#", current: false }
];
...
<template>
  <div class="min-h-full">
    <div class="bg-gray-800 pb-32 -mb-32">
            ...
            <div class="flex items-center justify-between h-16 px-4 sm:px-0">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <CubeTransparentIcon class="block h-8 w-8 text-rose-500"/>
                </div>
      ...
      <header class="py-10 ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold text-white">Weather Radar</h1>
        </div>
      </header>
    </div>
